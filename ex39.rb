require './dict_ex39.rb'

# calls the Dict.new() method which creates
# an array aDicht and fills it with the given number of num_buckets
# which is provided as a standard of 256
