...
module Parser
# peek method accepts a word_list, checks if one is given, if so the first variable
# of the array is stored in the word variable, else return nil
...
def self.match(word_list, expecting)
    if word_list
    	# .shift takes first value out of array and returns it
